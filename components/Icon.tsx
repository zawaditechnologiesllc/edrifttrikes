/**
 * Inline SVG icons for interactive chrome (header, cart, drawers).
 * These never depend on a web font, so navigation always renders and stays
 * tappable even if the icon font is slow or blocked.
 */
...
export function CartIcon({ className = base }: Props) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      ...
      <path d="M2.5 3h2l2.2 12.4a2 2 0 0 0 2 1.6h8.4a2 2 0 0 0 2-1.6L22 7H6" />
    </svg>
  );
}
