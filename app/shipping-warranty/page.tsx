...
const SHIPPING = [
  ...
  { title: "Delivery times", body: "Delivery takes 12–20 days from dispatch, depending on the shipping route to your country. Custom builds add 2–4 weeks of build time before dispatch." },
