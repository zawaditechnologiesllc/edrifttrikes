...
const FAQS = [
  ...
  { q: "Do you ship internationally?", a: "Yes — we manufacture and ship direct to every country. The total shown at checkout is the total you are charged, and nothing further is added." },
